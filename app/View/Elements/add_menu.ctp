<span class="glyphicon glyphicon-play song-controls action-play" title="<?php echo __('Play'); ?>"></span><span class="glyphicon glyphicon-pause song-controls action-pause" data-action="pause" title="<?php echo __('Pause'); ?>"></span><span class="dropdown"><span class="glyphicon glyphicon-plus song-controls action-add-to-playlist" data-toggle="dropdown" title="<?php echo __('Add to playlist'); ?>"></span>
